...
const _1 = require("./");
const EditGroupChat = ({ socket }) => {
    const { selectedChat, newChatName } = (0, hooks_1.useAppSelector)((state) => state.chat);
    const { user } = (0, hooks_1.useAppSelector)((state) => state.auth);
    const dispatch = (0, hooks_1.useAppDispatch)();
    const imageUploadRef = (0, react_1.useRef)(null);
    (0, react_1.useEffect)(() => {
        dispatch((0, chat_1.setNewChatName)(selectedChat === null || selectedChat === void 0 ? void 0 : selectedChat.chat_name));
    ...
    const handleImageChange = async (e) => {
        ...
        if (file) {
            ...
            try {
                if (selectedChat === null || selectedChat === void 0 ? void 0 : selectedChat.image_url) {
                    const id = (_c = (_b = (_a = selectedChat === null || selectedChat === void 0 ? void 0 : selectedChat.image_url) === null || _a === void 0 ? void 0 : _a.split('/')) === null || _b === void 0 ? void 0 : _b.at(-1)) === null || _c === void 0 ? void 0 : _c.split('.')[0];
                ...
                try {
                    dispatch((0, chat_1.updateImage)(url));
                    (_d = socket === null || socket === void 0 ? void 0 : socket.current) === null || _d === void 0 ? void 0 : _d.emit('sendMessage', {
                        sender: user,
                        chat: {
    ...
    return (<div className="w-full  h-full bg-slate-100 pb-12 dark:bg-slate-700 overflow-y-scroll">
      <div className="w-3/5 mx-auto h-full flex flex-col">
        <div className="bg-white dark:bg-slate-600 rounded-lg flex flex-col items-center p-4 mt-8">
          <div className="relative">
            <_1.Avatar size="xl" letter={selectedChat === null || selectedChat === void 0 ? void 0 : selectedChat.chat_name[0]} image_url={selectedChat === null || selectedChat === void 0 ? void 0 : selectedChat.image_url}/>
            <div onClick={() => { var _a; return (_a = imageUploadRef === null || imageUploadRef === void 0 ? void 0 : imageUploadRef.current) === null || _a === void 0 ? void 0 : _a.click(); }} className="absolute z-10 top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] cursor-pointer text-2xl text-white">
    ...
    onChange={(e) => handleImageChange(e)}/>
          ...
          <input type="text" className="w-full text-xs bg-transparent outline-none text-gray-700 dark:text-white" value={newChatName} onChange={(e) => dispatch((0, chat_1.setNewChatName)(e.target.value))}/>
          <hr className="w-full my-3 dark:border-gray-500"/>
          <input type="text" placeholder="Description" className="w-full text-xs bg-transparent outline-none dark:placeholder:text-gray-300 text-gray-700"/>
        </div>
        ...
        <div className="mt-8 bg-white dark:bg-slate-600 py-2 px-3 rounded-lg">
          ...
          <div className="w-full flex  gap-2  cursor-pointer">
            <div className="rounded text-white bg-green-500 p-1">
              <ri_1.RiShieldStarFill className="w-4 h-4"/>
            </div>
            <div className="flex items-center w-full  justify-between gap-[2px] text-xs ">
              <span className="text-gray-700 dark:text-white">
                Administrators
